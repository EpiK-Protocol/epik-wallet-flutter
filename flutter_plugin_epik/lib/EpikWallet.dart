...
class EpikWallet {
  ...
  Future<String> balance(String addr) async {
    try {
      return await EpikPlugin.channel.invokeMethod("epik_wallet_balance", <String, dynamic>{"addr": addr});
    } catch (e) {
      print(e);
    }
    return null;
  ...
  Future<String> export(String addr) async {
    try {
      String privateKey = await EpikPlugin.channel.invokeMethod("epik_wallet_export", <String, dynamic>{"addr": addr});
      return privateKey;
    } catch (e) {
      print(e);
    }
  ...
  Future<String> generateKey(Uint8List seed, String path, {String t = "bls"}) async {
    try {
      address = await EpikPlugin.channel
          .invokeMethod("epik_wallet_generateKey", <String, dynamic>{"t": t, "seed": seed, "path": path});
      return address;
    } catch (e) {
      print(e);
    }
  ...
  Future<bool> hasAddr(String addr) async {
    try {
      return await EpikPlugin.channel.invokeMethod("epik_wallet_hasAddr", <String, dynamic>{"addr": addr});
    } catch (e) {
      print(e);
    }
    return null;
  ...
  Future<String> import(String privateKey) async {
    try {
      address = await EpikPlugin.channel.invokeMethod("epik_wallet_import", <String, String>{"privateKey": privateKey});
      return address;
    } catch (e) {
      print(e);
    }
  ...
  Future<ResultObj<String>> send(String to, String amount) async {
    try {
      String ret =
          await EpikPlugin.channel.invokeMethod("epik_wallet_send", <String, dynamic>{"to": to, "amount": amount});
  ...
  Future setDefault(String addr) async {
    try {
      await EpikPlugin.channel.invokeMethod("epik_wallet_setDefault", <String, dynamic>{"addr": addr});
      return;
    } catch (e) {
      print(e);
    }
  ...
  Future setRPC(String url, String token) async {
    try {
      await EpikPlugin.channel.invokeMethod("epik_wallet_setRPC", <String, dynamic>{"url": url, "token": token});
      return;
    } catch (e) {
      print(e);
    }
  ...
  Future<Uint8List> sign(String addr, Uint8List hash) async {
    try {
      return await EpikPlugin.channel.invokeMethod("epik_wallet_sign", <String, dynamic>{"addr": addr, "hash": hash});
    } catch (e) {
      print(e);
    }
    return null;
  ...
  Future<ResultObj<String>> expertInfo(String addr) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_expertInfo", <String, dynamic>{
        "addr": addr,
      });
      return ResultObj<String>(data: ret);
    } catch (e, s) {
  ...
  Future<ResultObj<String>> expertNominate(String selfId, String targetId) async {
    try {
      String ret = await EpikPlugin.channel
          .invokeMethod("epik_wallet_expertNominate", <String, dynamic>{"selfId": selfId, "targetId": targetId});
      return ResultObj<String>(data: ret);
    } catch (e) {
      print(e);
      return ResultObj<String>.fromError(e);
  ...
  Future<ResultObj<String>> messageReceipt(String cidStr) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_messageReceipt", <String, dynamic>{
        "cidStr": cidStr,
      });
      return ResultObj<String>(data: ret);
    } catch (e, s) {
  ...
  Future<ResultObj<String>> voteRescind(String candidate, String amount) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_voteRescind", <String, dynamic>{
        "candidate": candidate,
        "amount": amount,
      });
      return ResultObj<String>(data: ret);
  ...
  Future<ResultObj<String>> voteSend(String candidate, String amount) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_voteSend", <String, dynamic>{
        "candidate": candidate,
        "amount": amount,
      });
      return ResultObj<String>(data: ret);
  ...
  Future<ResultObj<String>> voteWithdraw(String to) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_voteWithdraw", <String, dynamic>{
        "to": to,
      });
      return ResultObj<String>(data: ret);
    } catch (e, s) {
  ...
  Future<ResultObj<String>> voterInfo(String addr) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_voterInfo", <String, dynamic>{
        "addr": addr,
      });
      return ResultObj<String>(data: ret);
    } catch (e, s) {
  ...
  Future<ResultObj<String>> minerInfo(String minerID) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_minerInfo", <String, dynamic>{
        "minerID": minerID,
      });
      return ResultObj<String>(data: ret);
    } catch (e, s) {
  ...
  Future<ResultObj<String>> minerPledgeAdd(String toMinerID, String amount) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_minerPledgeAdd", <String, dynamic>{
        "toMinerID": toMinerID,
        "amount": amount,
      });
      return ResultObj<String>(data: ret);
  ...
  Future<ResultObj<String>> minerPledgeWithdraw(String toMinerID, String amount) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_minerPledgeWithdraw", <String, dynamic>{
        "toMinerID": toMinerID,
        "amount": amount,
      });
      return ResultObj<String>(data: ret);
  ...
  Future<ResultObj<String>> retrievePledgeAdd(String target, String toMinerID, String amount) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_retrievePledgeAdd", <String, dynamic>{
        "toMinerID": toMinerID,
        "target": target,
        "amount": amount,
      });
  ...
  Future<ResultObj<String>> retrievePledgeApplyWithdraw(String owner, String amount) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_retrievePledgeApplyWithdraw", <String, dynamic>{
        "target": owner,
        "amount": amount,
      });
      return ResultObj<String>(data: ret);
  ...
  // 矿机 访问抵押 撤回 第二步
  Future<ResultObj<String>> retrievePledgeWithdraw(
      /*String toMinerID,*/
      String amount) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_retrievePledgeWithdraw", <String, dynamic>{
  ...
  Future<ResultObj<String>> retrievePledgeBind(String toMinerID, String amount) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_retrievePledgeBind", <String, dynamic>{
        "miner": toMinerID,
        "amount": amount,
      });
      return ResultObj<String>(data: ret);
  ...
  Future<ResultObj<String>> retrievePledgeUnBind(String toMinerID, String amount) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_retrievePledgeUnBind", <String, dynamic>{
        "miner": toMinerID,
        "amount": amount,
      });
      return ResultObj<String>(data: ret);
...
//}
  Future<ResultObj<String>> coinbaseInfo(String addr) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_coinbaseInfo", <String, dynamic>{
        "addr": addr,
      });
      return ResultObj<String>(data: ret);
    } catch (e, s) {
...
//}
  Future<ResultObj<String>> coinbaseWithdraw() async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_coinbaseWithdraw", <String, dynamic>{});
      return ResultObj<String>(data: ret);
    } catch (e, s) {
      print(e);
      return ResultObj<String>.fromError(e);
  ...
  Future<ResultObj<String>> minerPledgeOneClick(List<String> minerIds) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_minerPledgeOneClick", <String, dynamic>{
  ...
  Future<ResultObj<String>> gasEstimateGasLimit({String actor = "transfer"}) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_gasEstimateGasLimit", <String, dynamic>{
        "actor": actor,
      });
      return ResultObj<String>(data: ret);
    } catch (e, s) {
  ...
  Future<ResultObj<String>> signAndSendMessage(String addr, String message) async {
    try {
      String ret = await EpikPlugin.channel
          .invokeMethod("epik_wallet_signAndSendMessage", <String, dynamic>{"addr": addr, "message": message});
      return ResultObj<String>(data: ret);
    } catch (e, s) {
      print(e);
      return ResultObj<String>.fromError(e);
  ...
  Future<ResultObj<Uint8List>> signCID(String addr, String cidStr) async {
    try {
      Uint8List ret = await EpikPlugin.channel
          .invokeMethod("epik_wallet_signCID", <String, dynamic>{"addr": addr, "cidStr": cidStr});
  ...
  Future<ResultObj<String>> minerPledgeApplyWithdraw(String minerID) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_minerPledgeApplyWithdraw", <String, dynamic>{
        "minerID": minerID,
      });
      return ResultObj<String>(data: ret);
    } catch (e, s) {
  ...
  Future<ResultObj<String>> minerPledgeTransfer(String fromMinerID, String toMinerID, String amount) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_minerPledgeTransfer", <String, dynamic>{
  ...
  Future<ResultObj<String>> minerPledgeApplyWithdrawOneClick(List<String> minerIds) async {
    try {
      String ret =
          await EpikPlugin.channel.invokeMethod("epik_wallet_minerPledgeApplyWithdrawOneClick", <String, dynamic>{
        "minerStr": minerIds.join(","),
      });
      return ResultObj<String>(data: ret);
    } catch (e, s) {
  ...
  Future<ResultObj<String>> minerPledgeWithdrawOneClick(List<String> minerIds) async {
    try {
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_minerPledgeWithdrawOneClick", <String, dynamic>{
        "minerStr": minerIds.join(","),
      });
      return ResultObj<String>(data: ret);
    } catch (e, s) {
  ...
  Future<ResultObj<String>> retrievePledgeState(String addr) async {
    try {
      ...
      String ret = await EpikPlugin.channel.invokeMethod("epik_wallet_retrievePledgeState", <String, dynamic>{
        "addr": addr,
      });
