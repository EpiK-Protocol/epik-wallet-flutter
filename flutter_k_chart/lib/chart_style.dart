...
class ChartColors {
  ...
  static const Color gridColor = Color(0x22000000); //Color(0xff4c5c74);//网格颜色
  ...
  static const Color upColor = Color(0xffcfe9bb);//Color(0x60AED581);  //Color(0xff4DAA90);
  static const Color dnColor = Color(0xfffeccdd);//Color(0x60FF80AB); //Color(0xffC15466);
  ...
  static const Color yAxisTextColor = Color(
      0x33000000); //Color(0xff60738E); //右边y轴刻度
  static const Color xAxisTextColor = Color(
      0x33000000); //Color(0xff60738E); //下方时间刻度

  static const Color maxMinTextColor = Color(
      0x66000000); //Color(0xffffffff); //最大最小值的颜色
  ...
  //选中后显示值边框颜色
  static const Color markerBorderColor = Color(0x206C7A86);
  //选中后显示值背景的填充颜色
  static const Color markerBgColor = Color(0xffb8cfea);//Color(0xff0D1722);
  static const Color markerTextColor = Color(0xffffffff);

  //实时线颜色等
  static const Color realTimeBgColor =Color(0xff4C86CD);//Color(0xff0D1722);// 圆框背景颜色
  static const Color realTimeBgColor_right = Color(0xffb8cfea);//Color(0xff4C86CD); // 最右边背景颜色
  static const Color rightRealTimeTextColor = Color(0xffb8cfea);//Color(0xff4C86CD); // 最右边时文字颜色
  ...
  //实时线
  static const Color realTimeLineColor = Color(0xffb8cfea);//Color(0xff4C86CD); //Color(0xffffffff);
  static const Color realTimeLongLineColor = Color(0xffb8cfea);//Color(0xff4C86CD);

  static const Color simpleLineUpColor = Color(0xff6CB0A6);
  static const Color simpleLineDnColor = Color(0xffC15466);

  static const Color vCrossColor = Color(0x10000000);
