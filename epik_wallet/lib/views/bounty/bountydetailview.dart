    ...
    ApiBounty.getBountyInfo(
      ...
      if (httpjsonres != null && httpjsonres.code == 0) {
        ...
        if (j_record != null && j_record.length > 0) {
          ...
          if (widget.bountyTask.status == BountyStateType.PUBLICITY && widget.bountyTask.getCountdownTimeNum()>0) {
      ...
      children: [
        ...
        Container(
          ...
          child: FlatButton(
            ...
            child: Text(
              "任务状态: ${widget?.bountyTask?.status.getName()} ${widget
                  ?.bountyTask?.getCountdownString()}",
              textAlign: TextAlign.center,
              style: TextStyle(
                color: Colors.white,
                fontSize: 16,
