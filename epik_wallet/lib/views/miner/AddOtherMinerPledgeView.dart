...
class AddOtherMinerPledgeView extends BaseWidget {
  @override
  BaseWidgetState<BaseWidget> getState() {
    return AddOtherMinerPledgeViewState();
  }
}

class AddOtherMinerPledgeViewState extends BaseWidgetState<AddOtherMinerPledgeView> {
  ...
  void didChangeDependencies() {
    ...
    setAppBarTitle(RSID.aompv_1.text);//"其他Owner");
  }
...
//              maxLength: 20, //允许输入的字符长度/ 右下角有数量提示
  ...
  ///添加流量抵押
  onClickRetrieveAdd(String minerID,String amount) {
    if(StringUtils.isEmpty(minerID))
    {
      ToastUtils.showToastCenter(RSID.aompv_4.text);//"请输入OwnerID");
      return;
    }
    ...
    BottomDialog.simpleAuth(
      ...
      ResultObj<String> robj = await AccountMgr()
          .currentAccount
          .epikWallet
          .minerPledgeAdd(minerID, amount.trim());
